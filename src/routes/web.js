...
let initRoutes = (app) => {
  ...
  //   router.post(
  //     "/set-info-booking-online-messenger",
  //     bot.setInfoBookingMessenger
  //   );
  ...
  router.get(
    "/supporter/pagination/posts",
    auth.checkLoggedIn,
    supporter.getPostsPagination
  );
  ...
  router.post(
    "/supporter/done-comment",
    auth.checkLoggedIn,
    supporter.postDoneComment
  );
  ...
  router.post(
    ...
    auth.checkLoggedIn,
    admin.postCreateSupporter // Hàm xử lý việc tạo Supporter mới
  );
  ...
  router.get(
    ...
    auth.checkLoggedIn,
    admin.getManageSpecialization
  );
  // Thêm chuyên khoa mới
  router.get(
    "/users/manage/specialization/create",
    auth.checkLoggedIn,
    admin.getCreateSpecialization // Hàm hiển thị trang tạo chuyên khoa
  );
  router.post(
    "/admin/specialization/create",
    auth.checkLoggedIn,
    admin.postCreateSpecialization // Hàm xử lý việc tạo chuyên khoa mới
  );
  ...
  router.delete(
    ...
    auth.checkLoggedIn,
    admin.deleteSpecializationById
  );
