...
const DOCTOR_IMAGE_URL =
  "https://bralowmedicalgroup.com/wp-content/uploads/2018/06/blog.jpg";
...
const COXUONGKHOP_IMAGE_URL =
  "https://cdn.pixabay.com/photo/2015/10/31/11/59/information-1015298_960_720.jpg";
const COXUONGKHOP_URL = "https://doctorcare-v1.herokuapp.com/";

const TIEUHOA_IMAGE_URL =
  "https://cdn.pixabay.com/photo/2015/10/31/11/59/information-1015298_960_720.jpg";
const TIEUHOA_URL = "https://doctorcare-v1.herokuapp.com/";

const INFOWEBSITE_IMAGE_URL =
  "https://cdn.pixabay.com/photo/2015/10/31/11/59/information-1015298_960_720.jpg";
    ...
    try {
      ...
      switch (payload) {
        ...
        case "RESTART_CONVERSATION":
          ...
          let text = `Xin chào ${username}. Mình là chat bot hỗ trợ CareLink. Bạn cần mình giúp gì nào?`;
...
let handleMessage = async (sender_psid, received_message) => {
  ...
  if (received_message.sticker_id) {
    await callSendAPI(
      sender_psid,
      "Cảm ơn bạn đã sử dụng dịch vụ của CareLink !!!"
    );
    return;
  }
  ...
  switch (name) {
    case "intent":
      if (entity.value === "doctors") {
        await callSendAPI(
          sender_psid,
          "Bạn đang tìm kiếm thông tin về bác sĩ, xem thêm ở link bên dưới nhé."
        );
        let title = "CareLink";
        let subtitle = "Thông tin bác sĩ làm việc tại CareLink";
        await callSendAPIv2(
          sender_psid,
          title,
          subtitle,
    ...
    case "booking":
      ...
      await callSendAPIv2(
        sender_psid,
        "Đặt lịch khám bệnh",
        "Hướng dẫn đặt lịch khám bệnh tại CareLink",
        BOOKING_IMAGE_URL,
        BOOKING_URL
      );
      await sendMessageDefault(sender_psid, "Xem thêm thông tin:");
    ...
    case "info":
      await callSendAPI(
        sender_psid,
        "Bạn đang tìm hiểu về thông tin website, xem thêm ở link bên dưới nhé."
      );
      await callSendAPIv2(
        sender_psid,
        "Thông tin website",
        "Thông tin website CareLink",
    ...
    default:
      ...
      await callSendAPIv2(
        sender_psid,
        "Hỗ trợ khách hàng",
        "Thông tin hỗ trợ khách hàng CareLink",
        DEFAULT_IMAGE_URL,
        DEFAULT_URL
      );
      await sendMessageDefault(sender_psid, "Xem thêm thông tin:");
...
let sendMessageMedicalExamination = (sender_psid) => {
  return new Promise(async (resolve, reject) => {
    try {
      let response1 = {
        text:
          "Quy trình khám bệnh với CareLink gồm những bước sau:" +
...
let sendMessageReplyDoctors = (sender_psid) => {
  return new Promise(async (resolve, reject) => {
    try {
      let response1 = {
        text:
          "CareLink tự hào mang đến cho bạn đội ngũ bác sĩ hàng đầu, chất lượng và uy tín." +
          "\n\nMột số bác sĩ tiêu biểu trên CareLink:",
      };
            ...
            elements: [
              {
                ...
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/users/doctor.jpg",
              ...
              },
              {
                ...
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/users/doctor-eric-pham.jpg",
...
let sendMessageReplySpecialization = (sender_psid) => {
  return new Promise(async (resolve, reject) => {
    try {
      let response1 = {
        text:
          "CareLink có đầy đủ các chuyên khoa khám chữa bệnh cho mọi lứa tuổi." +
          "\n\nMột số chuyên khoa tiêu biểu trên CareLink:",
      };
          ...
          payload: {
            ...
            elements: [
...

              {
                title: "THẦN KINH",
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/specializations/than-kinh.jpg",
                default_action: {
                  type: "web_url",
              ...
              },
              {
                title: "TIÊU HÓA",
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/specializations/tieu-hoa.jpg",
                default_action: {
                  type: "web_url",
...
let sendMessageReplyClinics = (sender_psid) => {
  return new Promise(async (resolve, reject) => {
    try {
      let response1 = {
        text:
          "CareLink có trên 20 cơ sở y tế, phòng khám hợp tác phát triển." +
          "\n\nMột số phòng khám tiêu biểu trên CareLink:",
      };
            ...
            elements: [
              {
                ...
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/clinics/phong-kham-thu-cuc.jpg",
                default_action: {
                  type: "web_url",
...

              {
                ...
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/clinics/phong-kham-meditec.jpg",
                default_action: {
                  type: "web_url",
              ...
              },
              {
                ...
                image_url:
                  "https://doctorcare-v1.herokuapp.com/images/clinics/phong-kham-bao-son.jpg",
                default_action: {
                  type: "web_url",
...
let sendMessageAllClinics = (sender_psid) => {
  return new Promise(async (resolve, reject) => {
    try {
      let response1 = {
        text:
          "Danh sách tất cả phòng khám bạn xem thêm ở link bên dưới nhé:" +
...
let chatWithCustomerService = (sender_psid) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let response1 = {
        text:
          "Bạn đã lựa chọn chat với hỗ trợ viên chăm sóc khách hàng" +
