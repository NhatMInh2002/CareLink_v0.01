...
export const transMailBookingNew = {
  subject: "Email notification of booking progress at CareLink",
  template: (data) => {
    return `<h3>Thank you for booking an appointment at CareLink's system </h3>
        ...
        <h4>CareLink system will automatically send email notification when confirmed appointment is complete. Thank you !</h4>`;
  },
};
